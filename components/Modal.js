...
function Modal() {
    ...
    <Transition.Root show={open} as={Fragment}>
        ...
        >
          ...
          justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
              <Transition.Child
                    as={Fragment}
              ...
              <Transition.Child
                    ...
                    leaveTo="opacity-0  translate-y-4 sm:translate-y-0 sm:scale-95">
                        ...
                        px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8
